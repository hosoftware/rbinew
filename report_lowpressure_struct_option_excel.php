...
//$objPHPExcel->getActiveSheet()->getStyle('A1:G1')->applyFromArray($tableheader);
	...
	$objPHPExcel->getActiveSheet()->mergeCells('AA'.$i.':AB'.($i+2));

	$objPHPExcel->getActiveSheet()->mergeCells('A'.$i.':B'.$i);
	$objPHPExcel->getActiveSheet()->getStyle('A'.$i.':AB'.$i)->applyFromArray($tableheader1);
...
$objPHPExcel->getActiveSheet()->getStyle('A'.$i.':AB'.$i)->applyFromArray($tableheader3);
...
$objPHPExcel->getActiveSheet()->getStyle('A'.($i+1).':AB'.($i+1))->applyFromArray($tableheader3);
$objPHPExcel->getActiveSheet()->getStyle('A'.($i+2).':AB'.($i+2))->applyFromArray($tableheader3);
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$i, "Quality Factor");

$objPHPExcel->getActiveSheet()->mergeCells('J'.$i.':J'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('J'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$i, "Joint Efficiency(W)");

$objPHPExcel->getActiveSheet()->mergeCells('K'.$i.':K'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('K'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$i, " Coeffienct(Y)");
$objPHPExcel->getActiveSheet()->getStyle('H'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->mergeCells('L'.$i.':L'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('L'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->getStyle('A'.($i).':AB'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->getStyle('A'.($i+1).':AB'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->getStyle('A'.($i+2).':AB'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$i, "Condition");
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.($i), "Schedule");
...
$objPHPExcel->getActiveSheet()->mergeCells('N'.($i).':N'.($i+2));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.($i), "Temp- rating (F)");
//$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.($i+2), "(F)");
$objPHPExcel->getActiveSheet()->mergeCells('O'.($i).':O'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('O'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$i, "Wall Thickness (mm)");
//$objPHPExcel->getActiveSheet()->mergeCells('J'.($i+1).':J'.($i+2));
//$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.($i+2), "(mm)");
$objPHPExcel->getActiveSheet()->mergeCells('P'.($i).':P'.($i+2));

$objPHPExcel->getActiveSheet()->getStyle('P'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.($i), "Corrosion Allowance (mm)");
$objPHPExcel->getActiveSheet()->mergeCells('Q'.($i).':T'.($i));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.$i, "Present Gauged Thickness(mm)");
$objPHPExcel->getActiveSheet()->mergeCells('Q'.($i+1).':Q'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('Q'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.($i+1), "3 O' CLOCK");
$objPHPExcel->getActiveSheet()->getStyle('R'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->mergeCells('R'.($i+1).':R'.($i+2));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R'.($i+1), "6 O' CLOCK");
$objPHPExcel->getActiveSheet()->getStyle('S'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->mergeCells('S'.($i+1).':S'.($i+2));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S'.($i+1), "9 O' CLOCK");
$objPHPExcel->getActiveSheet()->getStyle('T'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->mergeCells('T'.($i+1).':T'.($i+2));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T'.($i+1), "12 O' CLOCK");

$objPHPExcel->getActiveSheet()->getStyle('U'.($i+1))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->mergeCells('U'.($i).':U'.($i+2));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U'.($i), "Minimum Measured Thickness");
$objPHPExcel->getActiveSheet()->mergeCells('V'.($i).':V'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('V'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V'.($i), "Required Minimum Thickness");
$objPHPExcel->getActiveSheet()->mergeCells('W'.($i).':W'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('W'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.($i), "Diff in Tck ");
$objPHPExcel->getActiveSheet()->mergeCells('X'.($i).':X'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('X'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.($i), "Corrosion Rate per year");
$objPHPExcel->getActiveSheet()->mergeCells('Y'.($i).':Y'.($i+2));
$objPHPExcel->getActiveSheet()->getStyle('Y'.($i+2))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y'.($i), "Remaining Life (Yrs)");
$objPHPExcel->getActiveSheet()->getStyle('Z'.$i.':AA'.($i+2))->applyFromArray($tableheader3);
$objPHPExcel->getActiveSheet()->mergeCells('Z'.$i.':AA'.($i));
$objPHPExcel->getActiveSheet()->getStyle('Z'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$i, "Estimated Renewal");
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.($i+1), "<5 Years");
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.($i+1), "bet 5 & 9");
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.($i+2), "Est. Length in (mm)");
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.($i+2), "Est. Length in (mm)");
$objPHPExcel->getActiveSheet()->getStyle('AB'.($i).':AB'.($i+2))->applyFromArray($tableheader3);
$objPHPExcel->getActiveSheet()->mergeCells('AB'.($i).':AB'.($i+2));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB'.($i), "Remarks");
...
foreach($arr_project as $key=>$value) {
	$objPHPExcel->getActiveSheet()->getStyle('A'.$i.':AB'.$i)->applyFromArray($datacell);
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$i, $value['quality_factor']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$i, $value['weld_factor']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$i, $value['coefficient']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$i, $value['conditions']);

	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$i, $value['schedules']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.$i, $value['temperature']);

	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$i, $value['wall_tickness']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$i, $value['corrosion']);

	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.$i, $value['thickness5']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R'.$i, $value['thickness6']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S'.$i, $value['thickness7']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T'.$i, $value['thickness8']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U'.$i, $value['mean_thickness2']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V'.$i, $value['design_thickness']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$i, $value['diff_thickness']);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$i, $value['corrosion_rate']);
	if(is_numeric($value['remain_life']) && $value['remain_life']<5) {
		$objPHPExcel->getActiveSheet()->getStyle('Y'.$i)->applyFromArray($center2);
	}
	if($value['remain_life']>=5 && $value['remain_life']<=9) {
		$objPHPExcel->getActiveSheet()->getStyle('Y'.$i)->applyFromArray($center1);
	}
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y'.$i, $value['remain_life']);
...
$objPHPExcel->getActiveSheet()->mergeCells('O'.$i.':Y'.$i);
$objPHPExcel->getActiveSheet()->getStyle('O'.$i.':Y'.$i)->applyFromArray($center4);
$objPHPExcel->getActiveSheet()->getStyle('V'.$i.':AA'.$i)->applyFromArray($center3);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$i, '<5 Years');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$i, 'bet 5 & 9');
$i++;
$objPHPExcel->getActiveSheet()->getStyle('A'.$i.':AB'.$i)->applyFromArray($datacell);
$objPHPExcel->getActiveSheet()->getStyle('A'.$i.':AB'.$i)->applyFromArray($datacell);
...
$objPHPExcel->getActiveSheet()->getRowDimension($i+1)->setRowHeight(10);
$objPHPExcel->getActiveSheet()->getRowDimension(11)->setRowHeight(-1);
$objPHPExcel->getActiveSheet()->mergeCells('O'.$i.':Y'.($i+1));
$objPHPExcel->getActiveSheet()->getStyle('O'.$i.':Y'.$i)->applyFromArray($center);
$objPHPExcel->getActiveSheet()->getStyle('Z'.$i.':AA'.$i)->applyFromArray($center);
...
$objPHPExcel->getActiveSheet()->getStyle('Z'.$i.':AA'.$i)->applyFromArray($center4);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$i, $total_ton1);
...
$path3 = 'upload_low_pressure_img/'.$row_img['image3'];
$path4 = 'upload_low_pressure_img/'.$row_img['image4'];
$path5 = 'upload_low_pressure_img/'.$row_img['image5'];
$path6 = 'upload_low_pressure_img/'.$row_img['image6'];
$path7 = 'upload_low_pressure_img/'.$row_img['image7'];
$path8 = 'upload_low_pressure_img/'.$row_img['image8'];
$path9 = 'upload_low_pressure_img/'.$row_img['image9'];
$path10 = 'upload_low_pressure_img/'.$row_img['image10'];
$path11 = 'upload_low_pressure_img/'.$row_img['image11'];
$path12 = 'upload_low_pressure_img/'.$row_img['image12'];
$path13 = 'upload_low_pressure_img/'.$row_img['image13'];
$path14 = 'upload_low_pressure_img/'.$row_img['image14'];
$path15 = 'upload_low_pressure_img/'.$row_img['image15'];
...
if(!empty($row_img['image2'])) {
	...
	$objDrawing2->setCoordinates('H'.$i);    // pins the top-left corner of the image to cell D24
...
if(!empty($row_img['image3'])) {
	...
	$objDrawing3->setCoordinates('P'.$i);    // pins the top-left corner of the image to cell D24
...
if(!empty($row_img['image4'])) {
	...
	$objDrawing4->setCoordinates('X'.$i);    // pins the top-left corner of the image to cell D24
	$objDrawing4->setOffsetX(15);
	$objDrawing4->setOffsetY(15);
$objDrawing4->setWorksheet($objPHPExcel->getActiveSheet());
$objPHPExcel->getActiveSheet()->getStyle('W'.($i).':AB'.($i+12))->applyFromArray($imageborder);
}
$i++;
$i = $i+13;
...
$objPHPExcel->getActiveSheet()->getStyle('G'.($i).':N'.($i+2))->applyFromArray($imageborder);
$objPHPExcel->getActiveSheet()->mergeCells('G'.$i.':N'.$i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$i, $row_img['title2']);

$objPHPExcel->getActiveSheet()->getStyle('O'.($i).':V'.($i+2))->applyFromArray($imageborder);
$objPHPExcel->getActiveSheet()->mergeCells('O'.$i.':V'.$i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$i, $row_img['title3']);


$objPHPExcel->getActiveSheet()->mergeCells('W'.$i.':AB'.$i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$i, $i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$i, $row_img['title4']);
$objPHPExcel->getActiveSheet()->getStyle('W'.($i).':AB'.($i+2))->applyFromArray($imageborder);
$i++;
...
$objPHPExcel->getActiveSheet()->mergeCells('O'.$i.':V'.$i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$i, $row_img['description3']);
...
if(!empty($row_img['image6'])) {
	...
	$objDrawing6->setCoordinates('H'.$i);    // pins the top-left corner of the image to cell D24
...
if(!empty($row_img['image7'])) {
	...
	$objDrawing7->setCoordinates('P'.$i);    // pins the top-left corner of the image to cell D24
...
if(!empty($row_img['image8'])) {
	...
	$objDrawing8->setCoordinates('X'.$i);    // pins the top-left corner of the image to cell D24
...
$objPHPExcel->getActiveSheet()->getStyle('O'.($i).':V'.($i+2))->applyFromArray($imageborder);
$objPHPExcel->getActiveSheet()->mergeCells('O'.$i.':V'.$i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$i, $row_img['title7']);
...
$objPHPExcel->getActiveSheet()->mergeCells('O'.$i.':V'.$i);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$i, $row_img['description7']);
...
$objPHPExcel->getActiveSheet()->mergeCells('A'.($i).':F'.($i));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A'.($i), 'RATING');
$objPHPExcel->getActiveSheet()->getStyle('G'.($i).':N'.($i))->applyFromArray($border1);
$objPHPExcel->getActiveSheet()->mergeCells('G'.($i).':N'.($i));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$i, 'OBSERVATIONS');
$objPHPExcel->getActiveSheet()->getStyle('O'.($i).':AB'.($i))->applyFromArray($border1);
$objPHPExcel->getActiveSheet()->mergeCells('O'.($i).':AB'.($i));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.($i), 'RECOMMENDATIONS');
$i++;
$objPHPExcel->getActiveSheet()->getStyle('A'.($i).':F'.($i))->applyFromArray($border1);
$objPHPExcel->getActiveSheet()->getStyle('G'.($i).':N'.($i))->applyFromArray($border2);
$objPHPExcel->getActiveSheet()->getStyle('O'.($i).':AB'.($i))->applyFromArray($border2);
$objPHPExcel->getActiveSheet()->getStyle('A'.($i))->getAlignment()->setWrapText(true);
...
$objPHPExcel->getActiveSheet()->getStyle('G'.($i).':N'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->getActiveSheet()->mergeCells('O'.($i).':AB'.($i));
$objPHPExcel->getActiveSheet()->getStyle('O'.($i))->getAlignment()->setWrapText(true);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.($i), $row_img['recommendations2']);
$i=$i+2;
$objPHPExcel->getActiveSheet()->getStyle('A'.($i).':AB'.($i))->applyFromArray($tableheader);
$objPHPExcel->getActiveSheet()->mergeCells('A'.($i).':AB'.($i));
$objPHPExcel->getActiveSheet()->setBreak('A'.$i, PHPExcel_Worksheet::BREAK_ROW);
...
$objPHPExcel->getActiveSheet()->getPageSetup()->setPrintArea('A1:AB'.($i));
$objPHPExcel->getActiveSheet()->getPageSetup()->setPrintAreaByColumnAndRow(0,1,34,$i);
