...
<HTML>
  ...
  <script type="text/javascript" src="js/jquery-1.10.2.min.js"></script>
	...
	function deleteProject(project_id) {
		...
		if(confirm('Are you sure to delete?')) {
			location.href="lowpressure_project_listing.php?doAction=DeleteProject&project_id="+project_id;
		}
	}
 ...
 <BODY>
  <div class='main'>
	...
	<div class='container'>
		<div class='sect1'>
			<span class='h1'><strong>RISK BASED INSPECTION REGISTER (LOW PRESSURE)</strong></span><br />
